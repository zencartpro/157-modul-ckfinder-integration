...
/*
 * CKFinder Configuration File for Zen Cart 1.5.7 German
 * 2022-02-14 webchills
...
$config['authentication'] = function () {
    $allowed_ips = file_get_contents(realpath(__DIR__ . '/../') . '/.allowed_ips.txt');
    return strstr($allowed_ips, $_SERVER['REMOTE_ADDR']);
};
...
// Tragen Sie bei baseURL die URL zu Ihrem assets Verzeichnis ein
// Tragen Sie bei root den absoluten Pfad zu Ihrem assets Verzeichnis ein
